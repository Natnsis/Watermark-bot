...
/**
   ...
   * `prisma.watermark`: Exposes CRUD operations for the **Watermark** model.
    ...
    * ```
    */
  get watermark(): Prisma.WatermarkDelegate<ExtArgs, { omit: OmitOpts }>;

  /**
   * `prisma.refinement`: Exposes CRUD operations for the **Refinement** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Refinements
    * const refinements = await prisma.refinement.findMany()
    * ```
    */
  get refinement(): Prisma.RefinementDelegate<ExtArgs, { omit: OmitOpts }>;
}
